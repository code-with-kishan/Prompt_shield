...
A Dify tool plugin that provides local prompt injection detection, output scanning, and PII redaction powered by [prompt-shield](https://github.com/code-with-kishan/Prompt_Shield_Microsoft_Hackathon) (v0.4.0+).
